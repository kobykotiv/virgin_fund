...
async function getSupabaseCache(symbol: string, userId: string): Promise<any | null> {
  try {
...
async function recordSearch(symbol: string, userId: string, results: any): Promise<void> {
  try {
