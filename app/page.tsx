              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Automated Trading Platform for Everyone
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    GenEric TraDer bridges the gap between bot-based trading and copy trading with our isolated,
                    self-hosted platform. Connect to Alpaca Markets and CoinGecko for real-time data and paper trading.
                  </p>
                </div>
              ...
              <Card className="relative overflow-hidden border-2 border-muted bg-background/60 backdrop-blur-md shadow-lg">
                <CardContent className="p-6">
                  <div className="flex flex-col space-y-4">
                    ...
                    <p className="text-muted-foreground">Perfect for getting started and testing strategies</p>
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center">
                        <TrendingUp className="h-4 w-4 mr-2 text-green-500" />
                        <span>Up to 3 trading bots</span>
                      </li>
                      <li className="flex items-center">
                        <TrendingUp className="h-4 w-4 mr-2 text-green-500" />
              ...
              <Card className="relative overflow-hidden border-2 border-primary bg-background/60 backdrop-blur-md shadow-lg">
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col space-y-4">
                    ...
                    <p className="text-muted-foreground">For serious traders looking to automate their strategy</p>
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        <TrendingUp className="h-4 w-4 mr-2 text-green-500" />
              ...
              <Card className="relative overflow-hidden border-2 border-muted bg-background/60 backdrop-blur-md shadow-lg">
                <CardContent className="p-6">
                  <div className="flex flex-col space-y-4">
                    ...
                    <p className="text-muted-foreground">For professional trading firms and institutions</p>
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        <TrendingUp className="h-4 w-4 mr-2 text-green-500" />
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Self-hosted automated trading platform that bridges the gap between bot-based trading and copy trading.
              </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-xs text-muted-foreground">
              &copy; {new Date().getFullYear()} GenEric TraDer. All rights reserved.
            </p>
            <div className="flex gap-4">
